...
#include <stdio.h>
int dissassemblerIntel8080(char *codePtr, int pc) {
    char *code = &codePtr[pc]; //o ponteiro para char code recebe o endereço da última operação
